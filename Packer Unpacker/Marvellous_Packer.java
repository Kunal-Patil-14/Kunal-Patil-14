...
/* K:\LB\Project  2\Final Packer_Unpacker>java Marvellous_Packer
--------- Marvellous Packer Unpacker CUI Panel ---------
Enter folder name which contains the files that you want to pack :
Demo
Enter the name of packed file that you want to create :
Note : Packed file gets automatically created in the current directory.
Final.txt
File names are :
File Name : Hello.txt with length : 10bytes
File Name : India.txt with length : 20bytes
File Name : Logic.txt with length : 30bytes
----- Summary -----
Number of files scanned : 3
Number of files packed succesfully : 3
Thank you for using Marvellous Packer Unpacker Application */
